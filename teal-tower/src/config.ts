...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Goutokuji-osa", // Internal links should not include the base path, as it is automatically added
			external: true, // Show an external link icon and will open in a new tab
		},
		{
    		name: "Bilibili",
    		url: "https://space.bilibili.com/455877234",
    		external: true,
		},
	],
};
	...
	links: [
		{
			...
			url: "https://github.com/Goutokuji-osa",
		},
				{
    		name: "Bilibili",
